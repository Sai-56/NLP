...
def _PCA(X, num_components):
    ...
    # As you can see, the first two principal components contain 55% of
...
def convertToMatrix(dictn):
    ...
    print("Cos by Matrix:", numerator/(den*den1))
    ...
    print("Cos by PCA:", numerator/(den*den1))
